...
import { CreateBaysOfJoists } from './BiggerBaysOfJoists.js';
...
async function main() {
  ...
  progressText.innerText = "Hey, I am not a developer, and 1000 is a lot of joists, this takes a minute, please wait...";
